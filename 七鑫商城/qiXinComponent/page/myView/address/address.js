            ...
            <TouchableOpacity onPress={this._back.bind(this,rowData)} activeOpacity={1} style={{backgroundColor:'#ffffff',
                ...
                <View style={{
                    ...
                    <View style={{flexDirection:'row',backgroundColor:'#ffffff',height:WINHEIGHT*(0.04),width:WINWIDTH*(0.75)}}>
                        ...
                        }}>联系人:{rowData.realname}</Text>

                        <Text style={styles.TX3}>联系电话:{rowData.phone}</Text>
                    </View>
                    ...
                    <View style={{flex:1,backgroundColor:'#f5f5f5',marginTop:5}}>
                        ...
                        <Text style={styles.TX3}>省份:{rowData.city}</Text>
                        <Text style={styles.TX3}>区域:{rowData.area}</Text>
                        <Text style={styles.TX3}>详细:{rowData.area}</Text>
                    </View>
                </View>
    ...
    _handlePress(obj) {
        storage.load({
            ...
            if(ret.uid){
                ...
                fetch('http://'+ipdy+'/index.php?s=/Home/APPUser/delPersonalAddress/uid/'+ret.uid+'/address_id/'+obj.id+'/sign/'+(Cy('address_id='+obj.id+'&uid='+ret.uid+'&key='+qm)))
                    .then((response) => response.json())
                    .then((responseJson) =>{
                        console.log(responseJson)
                        Alert.alert(
