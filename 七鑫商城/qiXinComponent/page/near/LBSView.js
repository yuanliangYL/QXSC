 ...
 * [1,2,3,4].forEach(function (value, key, map) {
                            ...
                            <TouchableOpacity activeOpacity={1} style={{height:WINHEIGHT*(0.07),justifyContent:'center',marginLeft:10,borderBottomWidth:1,borderBottomColor:'#e6e6e6'
                            }}>
...
//区域
import Area from '../../../qiXinComponent/page/lbs/area';
//下一级详情
import MallD from '../../../qiXinComponent/page/near/Details';



import China from '../../china.json';
export default class lbsview extends Component {
    constructor(props) {
        super(props);
    ...
    //获取指定区域的商铺列表
    mm(obj) {
        console.log('http://' + ipdy + '/app_dev.php/business/disbusiness/' + this.state.lat + '/' + this.state.lng + '/' + this.state.province + '/' + this.state.city + '/' + obj)
    ...
    _dataView() {
        return (
            ...
            <View style={{flex:1}}>
                <Tou title="发现" navigator={this.props.navigator}/>
                ...
                <View style={{flex: 1}}>
                    ...
                    <View style={{marginLeft: 10, backgroundColor: '#ffffff', flex: 1, marginBottom: 50}}>
                        <ListView style={{}}
        ...
        return (
            <View style={{flex:1}}>
                ...
                alignItems: 'center'
                    ...
                    <TouchableOpacity onPress={this._area.bind(this)} style={{width:WINWIDTH*0.5,height:WINHEIGHT*0.06,justifyContent:'center',alignItems:'center',borderWidth:1,borderColor:filecolor,borderRadius:10,marginTop:20}}>
                        <Text style={{fontSize: WINWIDTH * 0.03, color: '#696969'}}>
                            点击选择
                        </Text>
                    </TouchableOpacity>
                </View>
