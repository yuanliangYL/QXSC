            ...
            <View style={{flex:1}}>
                ...
                <View style={{backgroundColor:filecolor,width:WINWIDTH,height:Platform.OS == 'ios' ? 44: WINHEIGHT*(0.06),flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                    ...
                    <View style={{width:WINWIDTH*(0.15),height:Platform.OS == 'ios' ? 44: WINHEIGHT*(0.06),flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                        {/*<TouchableOpacity activeOpacity={1} onPress={this._nextArea.bind(this)} style={{height:WINHEIGHT*0.03,width:WINWIDTH*(0.15),justifyContent:'center',alignItems:'center',borderRightWidth:0.5,borderRightColor:'#ffffff'}}>*/}
                            {/*<Text style={{color:'#ffffff',fontSize:WINWIDTH*0.035}}>{this.state.city}</Text>*/}
                        {/*</TouchableOpacity>*/}
                    </View>
...

                {
                    this.state.dataState==0&&this.state.dataHome==0?
                        ...
                        <View style={{flex:1,flexDirection:'row'}}>
                            <ScrollView style={{width:WINWIDTH*0.25,flex:1,backgroundColor:'#ffffff',marginBottom:50}}>
                            ...
                            <View style={{width:WINWIDTH*0.75,backgroundColor:'#e5e5e5',marginBottom:50}}>
                                    <ListView
